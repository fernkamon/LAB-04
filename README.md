...
จากผลการทดลอง พบว่า เมื่อทำการพิม์code 
```
Console.Write(“World”);
```
แล้วกดรัน มันจะขึ้นเพียงไม่นานนัก แต่เมื่อทำการกด ctrl + f5 แล้วเพื่อให้มันหยุดเวลาตอนรันไว้นั้น จะปรากฎข้อความดังรูปต่อไปนี้

![](https://github.com/fernkamon/LAB-04/blob/master/imgs/2.JPG)
<hr>
...
ผลที่ได้จากการทดลอง เป็นอย่างที่นักศึกษาคิดหรือไม่ อย่างไร  จงอธิบาย
    ...
    ไม่ เพราะคิดว่า สิ่งที่ปรากฎขึ้น จะมีเพียงแค่คำที่เรากำหนดเท่านั้น แต่ผลที่ออกมา ถึงจะมีคำที่เรากำหนด แต่ก็มีคำต่อท้ายที่ว่า Press any key to continueติดกัน กับคำที่ต้องการ
<hr>
<hr>
<hr>
...
จากผลการทดลอง จะได้ดังรูปภาพต่อไปนี้

![](https://github.com/fernkamon/LAB-04/blob/master/imgs/3.JPG)
<hr>
<hr>
...
![](https://github.com/fernkamon/LAB-04/blob/master/imgs/4.JPG)
<hr>
<hr>
...
จงอธิบายความแตกต่างระหว่างคำสั่ง Console.Write() และ Console.WriteLine()
 ...
 คำสั่ง Console.Write() เมื่อทำการรันผลออกมา บรรทัดจะอยู่ในบรรทัดเดียวกัน
 แต่ว่า คำสั่ง Console.WriteLine() เมื่อทำการรันผลออกมา ข้อความจะอยู่กันคนละบรรทัด 
<hr>
<hr>
<hr>
...
##สรุปผลการทดลอง
 ...
 เมื่อต้องการ รันผลการทำงาน ให้กด ctrl + f5 เพื่อให้เมื่อทำการรันแล้ว ผลจะหยุดที่การรันนั้น แต่ถ้ากดรันปกติ มันจะไวมากจนเหมือนไม่ได้รัน
 และคำสั่ง Console.Write() เมื่อทำการรันผลออกมา บรรทัดจะอยู่ในบรรทัดเดียวกัน แต่ว่า คำสั่ง Console.WriteLine() เมื่อทำการรันผลออกมา ข้อความจะอยู่กันคนละบรรทัด 
