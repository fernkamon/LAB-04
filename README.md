...
####บันทึกผลการทดลอง
  ...
  จากผลการทดลอง พบว่า เมื่อทำการกดรัน มันจะขึ้นเพียงไม่นานนัก แต่เมื่อทำการกด ctrl + f5 แล้วเพื่อให้มันหยุดเวลาตอนรันไว้นั้น จะปรากฎข้อความดังรูปต่อไปนี้

![](https://github.com/fernkamon/LAB-04/blob/master/imgs/1.JPG)
<hr>
<hr>
